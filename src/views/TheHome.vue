    ...
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold text-gray-900 mb-4">Welcome to Cross Companions</h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div class="text-center p-6 bg-white/60 rounded-xl shadow-lg">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-2">Study Groups</h3>
            <p class="text-gray-600">Connect with others and study the Bible together</p>
            <router-link
              to="/study-groups"
              class="inline-block mt-4 bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 transition-colors"
            >
              Explore Groups
            </router-link>
          </div>
