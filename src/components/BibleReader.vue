...
<template>
	<div
		class="flex-[3] h-full min-h-0 bg-white/60 rounded-xl shadow-lg p-8 flex flex-col gap-4 min-w-0 overflow-hidden"
	>
		...
		<div v-if="activeChapter" class="flex-1 flex flex-col min-h-0">
			<p class="text-lg text-neutral-70 mb-2">
				{{ bookData.name + ' ' + activeChapter.number }}
			</p>

			<!-- Text-to-Speech Controls -->
			<div class="flex flex-col sm:flex-row items-center gap-4 mb-4 p-3 bg-neutral-10 rounded-lg">
